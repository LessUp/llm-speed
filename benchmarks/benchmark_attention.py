...
def print_results(results: List[Dict]):
    ...
    for r in results:
        ...
        print(
            f"{r['seq_len']:>8} | {pytorch_ms:>10.3f} | {naive_ms:>10.3f} | {tiled_ms:>10.3f} | {flash_ms:>10.3f} | {speedup:>12.2f}x"
        )
    ...
    for r in results:
        ...
        print(
            f"{r['seq_len']:>8} | {pytorch_tflops:>12.2f} | {naive_tflops:>12.2f} | {tiled_tflops:>12.2f} | {flash_tflops:>12.2f}"
        )
