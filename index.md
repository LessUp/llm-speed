...
<section class="hero">
  <div class="hero-content">
    <div class="hero-badge">
      ...
      <span>v0.3.0 — Now with bilingual docs!</span>
    </div>
    ...
    <div class="hero-actions">
      ...
      <a href="{{ site.baseurl }}/docs/zh-CN/quickstart" class="btn btn-secondary">
        🇨🇳 中文文档
      </a>
...
<section class="features" style="background: var(--bg-body);">
  ...
  <div class="feature-grid" style="max-width: 1000px;">
    <a href="{{ site.baseurl }}/docs/en/quickstart" class="feature-card" style="text-decoration: none; color: inherit;">
      <div class="feature-icon">🚀</div>
      <h3>Quick Start</h3>
      <p>Get up and running in 5 minutes with installation and basic usage examples.</p>
    </a>
    <a href="{{ site.baseurl }}/docs/en/api" class="feature-card" style="text-decoration: none; color: inherit;">
      <div class="feature-icon">📚</div>
      <h3>API Reference</h3>
      <p>Complete API documentation with parameters, examples, and error handling.</p>
    </a>
    <a href="{{ site.baseurl }}/docs/en/architecture" class="feature-card" style="text-decoration: none; color: inherit;">
      <div class="feature-icon">🏗️</div>
      <h3>Architecture</h3>
      <p>Technical deep dive into CUDA kernels, optimization strategies, and implementation details.</p>
    </a>
    <a href="{{ site.baseurl }}/docs/en/performance" class="feature-card" style="text-decoration: none; color: inherit;">
      <div class="feature-icon">⚡</div>
