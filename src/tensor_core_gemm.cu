...
__global__ void tensor_core_gemm_fp16_kernel(const half* __restrict__ A,
...
__global__ void tensor_core_gemm_tiled_kernel(const half* __restrict__ A,
                                              const half* __restrict__ B,
                                              float* __restrict__ C,
                                              int M,
                                              int N,
...
__global__ void tensor_core_gemm_int8_kernel(const int8_t* __restrict__ A,
    ...
    wmma::fragment<wmma::matrix_a, WMMA_M_INT8, WMMA_N_INT8, WMMA_K_INT8, int8_t, wmma::row_major>
        a_frag;
    wmma::fragment<wmma::matrix_b, WMMA_M_INT8, WMMA_N_INT8, WMMA_K_INT8, int8_t, wmma::col_major>
        b_frag;
...
// Host wrappers
void tensor_core_gemm_fp16(const half* A,
                           const half* B,
                           float* C,
                           int M,
                           int N,
    ...
    tensor_core_gemm_tiled_kernel<BLOCK_M, BLOCK_N, BLOCK_K>
...
void tensor_core_gemm_int8(
    const int8_t* A, const int8_t* B, int32_t* C, int M, int N, int K, cudaStream_t stream) {
